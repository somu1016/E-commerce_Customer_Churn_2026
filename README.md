...
```bash
python churn_analysis.py --no-shap  # skip optional SHAP charts
python churn_analysis.py --show     # display charts while running
```
...
7. Save best-model confusion-matrix, precision-recall, feature-importance, and optional SHAP charts.
...
See [PROJECT_REPORT.md](PROJECT_REPORT.md) for the methodology, audit notes, and interpretation guidance.
